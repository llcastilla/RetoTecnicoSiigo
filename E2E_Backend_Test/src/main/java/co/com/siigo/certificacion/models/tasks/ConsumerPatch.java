...
public class ConsumerPatch implements Task {

    String query;

    public ConsumerPatch(String query) {
        this.query = query;
    }
    ...
    public static ConsumerPatch elServicio(String query) {
        return Instrumented.instanceOf(ConsumerPatch.class).withProperties(query);
    }
}
