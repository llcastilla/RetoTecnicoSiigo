...
public class RegistrarClienteError implements Task {
    private final DataCliente dataCliente;
    private final Contacto contacto;

    public RegistrarClienteError(DataCliente dataCliente, Contacto contacto) {
    ...
    public static RegistrarClienteError registrarCliente(DataCliente dataCliente, Contacto contacto) {
        return Tasks.instrumented(RegistrarClienteError.class, dataCliente, contacto);
    }
}
